...
<footer class="row row-cols-1 row-cols-sm-2 row-cols-md-2 row-cols-lg-5 row-cols-xl-7 py-5 my-5 border-top">
    <div class="col mb-3">
        ...
        <li class="nav-item mb-2"><a class="nav-link p-0 text-body-secondary" href="/search/?type=good_news">The Good News</a></li>
            ...
            <li class="nav-item mb-2"><a class="nav-link p-0 text-body-secondary" href="/our-sponsors">Our sponsors</a></li>
        </ul>
    </div>
...
<div class="d-flex flex-column flex-sm-row justify-content-between">
    ...
    <ul class="list-unstyled d-flex">
        <!-- YouTube -->
        <li class="ms-3">
            <a class="link-body-emphasis" href="https://www.youtube.com/@crossoverglobal478" target="_blank">
        ...
        <li class="ms-3">
        <!-- Facebook -->
            <a class="link-body-emphasis" target="_blank" href="https://www.facebook.com/people/Crossover-Global-Facilitating-Ministry-Inc/100063746584058/">
